...
public class FreeCrmTest {
	...
	public void setUp() throws Exception {
		System.setProperty("webdriver.chrome.driver", "/Users/shivanikumari/Downloads/chromedriver");
	...
	public static void getRunTimeInfoMessage(String messageType, String message) throws InterruptedException {
		...
		// js.executeScript("$.getScript('/Users/shivanikumari/git/SeleniumAutomation/src/test/jquery.growl.js')");
...
//		js.executeScript("$.growl.warning({ title: 'Warning!', message: 'your warning message goes here' });");
	...
	public static void takeScreenshot(String fileName) throws IOException{
		...
		FileUtils.copyFile(src, 
				new File("/Users/shivanikumari/git/SeleniumAutomation/screenshots/" + fileName +".png"));
